	...
	return [
		'json' => [
			'global' => [
				...
				"gridGapMobile" => (string) $site->gridGapMobile() . "px",
				"gridMarginMobile" => (string) $site->gridMarginMobile() . "px",
				"gridGapDesktop" => (string) $site->gridGapDesktop() . "px",
				"gridMarginDesktop" => (string) $site->gridMarginDesktop() . "px",
